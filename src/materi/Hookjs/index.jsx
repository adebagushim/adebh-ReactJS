    ...
    useEffect(() => {
        ...
        return( 
            <Container>
                ...
                <Row className="isi">
                    {data.filter((value) => {
                        return value.title?.toLowerCase().includes(cari.toLocaleLowerCase()) || value.description?.toLowerCase().includes(cari.toLocaleLowerCase()) || value.source.name?.toLowerCase().includes(cari.toLocaleLowerCase())
                        })
                        .map((user) => 
